...
<table>
	<tr>
		<td><?php echo form_label(_('Old Password'), $old_password['id']); ?></td>
	...
	<tr>
		<td><?php echo form_label(_('New Password'), $new_password['id']); ?></td>
	...
	<tr>
		<td><?php echo form_label(_('Confirm New Password'), $confirm_new_password['id']); ?></td>
...
<?php echo form_submit('change', _('Change Password')); ?>
<?php echo form_close(); ?>
