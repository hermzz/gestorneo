...
<form action="#" method="post">
	...
	<fieldset id="other_transportation">
		...
		<input type="text" class="form-control" id="trip_name" name="trip_name" value="<?=set_value('trip_name');?>" />
		<span class="form_help">(<?=_('ie: EZY 1234 o AVE 03112');?>)</span>
		<br />

		<label for="other_origin"><?=_('Origin');?></label>
		<input type="text" class="form-control" id="other_origin" name="other_origin" value="<?=set_value('other_origin');?>" /><br />

		<label for="departure_time"><?=_('Departure time');?></label>
		<input type="text" class="form-control" id="departure_time" name="departure_time" value="<?=set_value('departure_time');?>" /><br />

		<label for="other_destination"><?=_('Destination');?></label>
		<input type="text" class="form-control" id="other_destination" name="other_destination" value="<?=set_value('other_destination');?>" /><br />

		<label for="arrival_time"><?=_('Arrival time');?></label>
		<input type="text" class="form-control" id="arrival_time" name="arrival_time" value="<?=set_value('arrival_time');?>" /><br />
	...
	<fieldset id="car_transportation">
		...
		<input type="text" class="form-control" id="car_origin" name="car_origin" value="" /><br />

		<label for="car_destination"><?=_('Destination');?></label>
		<input type="text" class="form-control" id="car_destination" name="car_destination" value="" /><br />

		<label for="car_departure_time"><?=_('Departure time');?></label>
		<input type="text" class="form-control" id="car_departure_time" name="car_departure_time" value="" /><br />
